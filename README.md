...
知识库围绕 **4 大学习模块 + 2 个辅助板块**，覆盖 AI Infra 工程师需要掌握的关键技术栈：
...
| 序号 | 文章 | 说明 |
|:---:|------|------|
| 1 | [GPU 基础知识：从硬件架构到 AI 计算](https://caomaolufei.github.io/AIInfraGuide/prerequisites/gpu-basics/) | CPU vs GPU、SM 架构、显存层级、Tensor Core |
| 2 | [NVIDIA GPU 架构演进：从 Volta 到 Blackwell](https://caomaolufei.github.io/AIInfraGuide/prerequisites/nvidia-gpu-evolution/) | V100 → A100 → H100 → B200 架构演进 |
| 3 | [Transformer 架构：快速入门篇](https://caomaolufei.github.io/AIInfraGuide/prerequisites/20-transformer架构入门/) | Encoder-Decoder 结构、Self-Attention 机制入门 |
| 4 | [AI Infra 工程师为什么必须懂 Transformer](https://caomaolufei.github.io/AIInfraGuide/prerequisites/21-ai-infra工程师为什么必须懂transformer/) | 从 Infra 视角理解 Transformer 的计算与显存特性 |
| 5 | [Transformer 全貌及代码实现](https://caomaolufei.github.io/AIInfraGuide/prerequisites/22-transformer全貌及代码实现/) | 完整 Transformer 架构拆解与 PyTorch 实现 |
...
| 序号 | 文章 | 说明 |
|:---:|------|------|
| 1 | [CUDA 编程入门指南](https://caomaolufei.github.io/AIInfraGuide/cuda/cuda编程入门指南/) | CUDA 编程模型、线程层级、内存模型与 Kernel 编写 |
...
| 序号 | 文章 | 说明 |
|:---:|------|------|
| 1 | [PyTorch 分布式训练：从原理到实战](https://caomaolufei.github.io/AIInfraGuide/distributed/pytorch-distributed/) | DDP、FSDP、ZeRO、通信原语、torchrun 多机训练 |
